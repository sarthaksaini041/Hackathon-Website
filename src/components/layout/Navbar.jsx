      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl neumorph-sm text-muted dark:text-dark-muted hover:text-text dark:hover:text-dark-text cursor-pointer transition-colors"
          >
